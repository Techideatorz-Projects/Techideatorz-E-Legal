 ...
 */
$cakeDescription = __d('cake_dev', 'eLegal: An enterprenure Appllication');
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        //load layout css files
        echo $this->Html->css('bootstrap-cerulean.css');
        echo $this->Html->css('elegal-app.css');
        ...
        echo $this->Html->script('jquery.chosen.min.js');
        echo $this->Html->script('jquery.uniform.min.js');
        echo $this->Html->script('elegal.js');
        //echo $this->fetch('css');
        ?>
    </head>
    <body>
